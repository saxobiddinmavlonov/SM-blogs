...
function CategoriesTagsCard(item: Props) {
	return (
		<Link
			className='bg-secondary p-4  rounded-md shadow-xl flex flex-col items-center  justify-center hover:bg-secondary/80 transition-colors dark:shadow-white/15 space-y-2'
