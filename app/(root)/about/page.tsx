	...
	return (
		<div className='max-w-6xl mx-auto'>
			...
			<div className='grid grid-cols-4 gap-4 min-h-96 mt-6'>
				...
				<div className='max-md:col-span-2 self-end max-md:h-72 relative h-80'>
					<Image
						src={'/about/00.jpg'}
						alt='about'
						fill
				...
				<div className='max-md:col-span-2 max-md:mb8 max-md:h-72 relative h-80'>
					<Image
						src={'/about/02.jpg'}
						alt='about'
						fill
